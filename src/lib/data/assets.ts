...
const Assets = {
	WPF: a('wpf.png'),
	NET_Core_Logo: a('NET_Core_Logo.svg'),
	Intelifox_logo: a('intelifox_logo.jpeg'),
	RCRM: a('racin-RCRM.png'),
	Gmp: a('logo-gmp.png'),
	Doctory: a('doctory.png'),
	Yes_events: a('yes-events.png'),
	Broker_ph: a('broker-ph.png'),
	AWS: a('aws.svg'),
