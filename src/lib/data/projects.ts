...
export const items: Array<Project> = [
	...
	},
	{
		...
		color: '#ff3e00',
		description:
			'Yes Events designed for the pharmaceutical industry to streamline the process of booking visitor badges. This application simplifies the registration process for pharmaceutical events, allowing users to easily request and obtain their visitor badges electronically. In addition to badge booking, the application provides users with up-to-date news on upcoming pharmaceutical events, keeping them informed about key industry gatherings, conferences, and seminars. Users can conveniently receive their badges instantly, reducing wait times and enhancing their event experience. The platform’s integration of event information and badge management ensures a seamless and efficient experience for all attendees, making it an essential tool for professionals in the pharmaceutical field.',
		shortDescription:
			'Application for booking visitor badges in the pharmaceutical field, in addition this application provides news on pharmaceutical events',
		links: [{ to: 'https://play.google.com/store/apps/details?id=com.yes_expo&hl=en_US&pli=1', label: 'PlayStore' }],
		logo: Assets.Yes_events,
		name: 'Yes Events',
		period: {
			from: new Date(2022, 8, 19),
			to: new Date(2022, 9, 24),
		},
		skills: getSkills('flutter', 'dart'),
		type: 'Mobile application',
		screenshots: [
